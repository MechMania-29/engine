...
public class GetPossibleAttackActionsTest {
    ...
    private final Position up1left2 = new Position(center.getX() - 2, center.getY() - 1);
    private final Position up1right2 = new Position(center.getX() + 2, center.getY() - 1);
    private final Position down1left2 = new Position(center.getX() - 2, center.getY() + 1);
    private final Position down1right2 = new Position(center.getX() + 2, center.getY() + 1);
    ...
    @Test
    public void range2PlusHuman() {
        List<AttackAction> attackExpected = List.of(
                new AttackAction(human.getId(), zombie.getId(), AttackActionType.CHARACTER),
                new AttackAction(human.getId(), up1.toString(), AttackActionType.TERRAIN),
                new AttackAction(human.getId(), down1.toString(), AttackActionType.TERRAIN),
                new AttackAction(human.getId(), up1left1.toString(), AttackActionType.TERRAIN),
                new AttackAction(human.getId(), down1left1.toString(), AttackActionType.TERRAIN),
                new AttackAction(human.getId(), up1right1.toString(), AttackActionType.TERRAIN),
                new AttackAction(human.getId(), down1right1.toString(), AttackActionType.TERRAIN),
                new AttackAction(human.getId(), left2.toString(), AttackActionType.TERRAIN),
                new AttackAction(human.getId(), right2.toString(), AttackActionType.TERRAIN)
        );
        human.applyClassData(new CharacterClassData(1, 1, 2, 0, List.of()));
        List<AttackAction> attack2 = game.getPossibleAttackActions(false).get(human.getId());
        human.applyClassData(new CharacterClassData(1, 1, 3, 0, List.of()));
        List<AttackAction> attack3 = game.getPossibleAttackActions(false).get(human.getId());
        human.applyClassData(new CharacterClassData(1, 1, 4, 0, List.of()));
        List<AttackAction> attack4 = game.getPossibleAttackActions(false).get(human.getId());

        assertListContentsEqual(attackExpected, attack2);
        assertListContentsEqual(attackExpected, attack3);
        assertListContentsEqual(attackExpected, attack4);
    }

    @Test
    public void range2PlusZombie() {
        List<AttackAction> attackExpected = List.of(
                new AttackAction(zombie.getId(), human.getId(), AttackActionType.CHARACTER),
                new AttackAction(zombie.getId(), up1.toString(), AttackActionType.TERRAIN),
                new AttackAction(zombie.getId(), down1.toString(), AttackActionType.TERRAIN),
                ...
                new AttackAction(zombie.getId(), down1left1.toString(), AttackActionType.TERRAIN),
                new AttackAction(zombie.getId(), down1right1.toString(), AttackActionType.TERRAIN),
                new AttackAction(zombie.getId(), left2.toString(), AttackActionType.TERRAIN),
                new AttackAction(zombie.getId(), right2.toString(), AttackActionType.TERRAIN),
                new AttackAction(zombie.getId(), up1left2.toString(), AttackActionType.TERRAIN),
                new AttackAction(zombie.getId(), up1right2.toString(), AttackActionType.TERRAIN),
                new AttackAction(zombie.getId(), down1left2.toString(), AttackActionType.TERRAIN),
                new AttackAction(zombie.getId(), down1right2.toString(), AttackActionType.TERRAIN)
        );
        zombie.applyClassData(new CharacterClassData(1, 1, 2, 0, List.of()));
        List<AttackAction> attack2 = game.getPossibleAttackActions(true).get(zombie.getId());
        zombie.applyClassData(new CharacterClassData(1, 1, 3, 0, List.of()));
        List<AttackAction> attack3 = game.getPossibleAttackActions(true).get(zombie.getId());
        zombie.applyClassData(new CharacterClassData(1, 1, 4, 0, List.of()));
        List<AttackAction> attack4 = game.getPossibleAttackActions(true).get(zombie.getId());
